...
python3 generate_figures.py --no-variance $FOLDER/1.csv $PLATFORM --ylim 2
rm $FOLDER/1.csv
...
python3 generate_figures.py --no-variance $FOLDER/2a.csv $PLATFORM --ylim 16
rm $FOLDER/2a.csv
...
python3 generate_figures.py --no-variance $FOLDER/3.csv $PLATFORM --ylim 16
